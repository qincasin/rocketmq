...
//图解参考链接：(https://raw.githubusercontent.com/qincasin/oss/main/uPic/20221120/4.PullMessageProcessor处理器.jpg)
public class PullMessageProcessor extends AsyncNettyRequestProcessor implements NettyRequestProcessor {
    ...
    private RemotingCommand processRequest(final Channel channel, RemotingCommand request, boolean brokerAllowSuspend)
        ...
        if (getMessageResult != null) {
            ...
            // 根据getMessageResult的状态 设置 response的code ，参考下面的图，不要去看这块代码了..
            //状态码对应关系参考链接：https://raw.githubusercontent.com/qincasin/oss/main/uPic/20221120/消费者-服务器-Store 状态码对照表.jpg
            ...
            switch (response.getCode()) {
                ...
                case ResponseCode.PULL_NOT_FOUND:
                    ...
                    // 举例子，当dataSize 内存储一条 CQ(Consumer Queue)Data 时， dataSize = 20
