...
public class DefaultMQPushConsumer extends ClientConfig implements MQPushConsumer {
     ...
     * </li>
     * </ul>
     * 当从broker获取当前组内 该queue 的offset 不存在时，consumerFromWhere 才有效
     * 默认 ConsumeFromWhere.CONSUME_FROM_LAST_OFFSET ：标识从队列的最后offset 开始消费，当队列内在有一条新的 msg加入进入时，消费者才会去消费
     */
     ...
     */
    // 本地队列快照（processQueue）中，第一条消息 和 最后一条消息  他们之间的offset跨度 不能超过 2000  (队列流控使用)
     ...
     */
    // 主题流控，消费者消费的指定主题的所有消息  在本地 不能超过 “pullThresholdSizeForTopic” mib。 -1 表示不限制
